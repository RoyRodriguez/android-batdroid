   ...
   //import android.view.InflateException;
	...
	/**
 	* This class is the main class, responsible for initiating the BATDROID application.
 	*/
    ...
    public class batdroid extends Activity implements OnClickListener
   {
    ...
    /**
     * 
     * Does method calls to start or stop the BATDROID apllication.
     * 
     */
    ...
    /**
     * 
     * Changes the BATDROID logo when started/stopped 
     */
    ...
    /**
     * Displays message if there is no root access on the phone
     * 
     */
