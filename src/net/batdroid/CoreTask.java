 ...
 */
   ...
   import android.tether.system.NativeTask;
	...
	/**
	* Class that handles the updating of configuration files
	*/
      ...
      */
      ...
      /**
        ...
        */
   	  ...
   	  /**
        * Sets the file permissons on a file
        * @param file File on which permissions are to be set
        * @param mode The permissions for that file (eg. 0755)
        */
    ...
    */
      ...
      /* TODO if ((new File("/proc/config.gz")).exists() == false) {
   ...
   */
    ...
    /**
    *	Method to check if a particular process is runnning
    ...
    */
      ...
      // Overwriting runningProcesses
   	...
   	/**
        * Tests if the phone has been rooted by checking if /system/xbin/su exists or /system/bin/su exists
        */
   ...
   */
    ...
    */
    ...
    /**
    *	Get the last modified times of a file
    * @param filename File of which last modified time is wanted
    */
